# Generated by Django 5.2 on 2025-05-23 20:18
            ...
            try:
                ...
                if default_storage.exists(file_path):
                    ...
                    with default_storage.open(file_path, 'rb') as f:
                        ...
                        print(f"Конвертирована аватарка для пользователя {user.email}")
...
def reverse_migration(apps, schema_editor):
    """
    Обратная миграция - ничего не делаем, так как файлы аватарок остаются
    """
    pass
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # Добавляем операцию конвертации после создания полей
        migrations.RunPython(convert_avatars_to_base64, reverse_migration),
    ]
